...
-----END PUBLIC KEY-----';
     ...
     */
    public function test_get_lti_types_and_proxies_count_all() {
        $this->resetAfterTest(true);
        $this->setAdminUser();
        for ($i = 0; $i < 10; $i++) {
            $proxy = $this->generate_tool_proxy($i);
     ...
     */
    public function test_get_lti_types_and_proxies_count_orphaned_proxies() {
        $this->resetAfterTest(true);
        $this->setAdminUser();
        for ($i = 0; $i < 10; $i++) {
            $proxy = $this->generate_tool_proxy($i);
    ...
    public function test_get_lti_types_and_proxies_count_type_with_proxyid() {
        ...
        $countwithproxyid = lti_get_lti_types_and_proxies_count(false, $proxy->id);
